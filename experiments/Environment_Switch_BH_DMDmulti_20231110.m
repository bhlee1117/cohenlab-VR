 function code = Environment_Switch_BH_DMDmulti_20231110
...
if isequal(vr.exper.movementFunction, @runFromRecording)
    ...
    %initial conditions
    vr.trialNumber=1;
    vr.NDMDpattern=6; %multiply cell# and number of stimulation
    ...
    vr.stim_lap={[6],[11],[16],[21],[26],[31]};
    %vr.pulse_type=[0 0 0 0 1 1 1 1]; %0=constant, 1=pulsed
    vr.pulse_type=[2 1 2 1 0 0]; %0=constant, 1=pulsed
    ...
    vr.zap_pos=vr.endPosition*[0.6 0.35 0.1 0.6 0.35 0.1];
