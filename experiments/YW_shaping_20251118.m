function code =YW_shaping_20251118
...
% if VR trigger
% Random_delay=randi([1 500],1);
% pausetimer = timer;
% pausetimer.=Random_delay;
% pausetimer.StartDelay = 0.1;
% pausetimer.TimerFcn = @(~,~)write(obj.waterSession, [0]);
% start(pausetimer);
% halttime=now
