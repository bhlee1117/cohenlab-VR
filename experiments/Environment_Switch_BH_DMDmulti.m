 function code = Environment_Switch_BH_DMDmulti
...
if isequal(vr.exper.movementFunction, @runFromRecording)
    ...
    %initial conditions
    vr.trialNumber=1;
    vr.NDMDpattern=4; %multiply cell# and number of stimulation
    ...
    vr.stim_lap={[7],[13],[19],[25]};
    %vr.pulse_type=[0 0 0 0 1 1 1 1]; %0=constant, 1=pulsed
    vr.pulse_type=[0 0 1 1]; %0=constant, 1=pulsed
    ...
    vr.zap_pos=vr.endPosition*[0.2 0.6 0.2 0.6];
